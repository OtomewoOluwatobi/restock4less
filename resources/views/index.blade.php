...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('landing_page/css/vendor.css') }}">
            ...
            <div class="row py-3 border-bottom">
                <div
                    ...
                    <div class="d-flex align-items-center my-3 my-sm-0">
                        <a href="index.html">
                            <img src="{{ asset('landing_page/images/logo.svg') }}" alt="logo" class="img-fluid">
                        </a>
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            @php
                                $categories = [
                                    ['image' => 'category-thumb-1.jpg', 'title' => 'Fruits & Veges'],
                                    ['image' => 'category-thumb-2.jpg', 'title' => 'Breads & Sweets'],
                                    ['image' => 'category-thumb-3.jpg', 'title' => 'Fruits & Veges'],
                                    ['image' => 'category-thumb-4.jpg', 'title' => 'Beverages'],
                                    ['image' => 'category-thumb-5.jpg', 'title' => 'Meat Products'],
                                    ['image' => 'category-thumb-6.jpg', 'title' => 'Breads'],
                                    ['image' => 'category-thumb-7.jpg', 'title' => 'Fruits & Veges'],
                                    ['image' => 'category-thumb-8.jpg', 'title' => 'Breads & Sweets'],
                                    ['image' => 'category-thumb-1.jpg', 'title' => 'Fruits & Veges'],
                                    ['image' => 'category-thumb-1.jpg', 'title' => 'Beverages'],
                                    ['image' => 'category-thumb-1.jpg', 'title' => 'Meat Products'],
                                    ['image' => 'category-thumb-1.jpg', 'title' => 'Breads'],
                                ];
                            @endphp

                            @foreach ($categories as $category)
                                <a href="category.html" class="nav-link swiper-slide text-center">
                                    <img src="{{ asset('landing_page/images/' . $category['image']) }}"
                    ...
                    <div
                            ...
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('landing_page/images/product-thumb-1.png') }}" alt="Product Thumbnail"
                                            class="tab-image">
                                    </a>
                                </figure>
                        ...
                        <div class="col">
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('landing_page/images/product-thumb-2.png') }}" alt="Product Thumbnail"
                                            class="tab-image">
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                        ...
                        <div class="col">
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('landing_page/images/product-thumb-3.png') }}" alt="Product Thumbnail"
                                            class="tab-image">
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                        ...
                        <div class="col">
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('landing_page/images/product-thumb-4.png') }}" alt="Product Thumbnail"
                                            class="tab-image">
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
                        ...
                        <div class="col">
                            <div class="product-item">
                                <figure>
                                    <a href="index.html" title="Product Title">
                                        <img src="{{ asset('landing_page/images/product-thumb-5.png') }}" alt="Product Thumbnail"
                                            class="tab-image">
                                    </a>
                                </figure>
                                <div class="d-flex flex-column text-center">
    ...
    <section>
        <div class="container-lg">
            ...
            <div class="bg-secondary text-light py-5 my-5"
                style="background: url('{{asset('landing_page/images/banner-newsletter.jpg')}}') no-repeat; background-size: cover;">
                <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <img src="{{ asset('landing_page/images/logo.svg') }}" width="240" height="70" alt="logo">
